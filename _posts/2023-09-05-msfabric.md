...
![Desktop View](/assets/img/medallion/msfabric-medallion-arch.png)

## Create a Workspace

Login to MS Fabric and create new workspace ==> ... ==> Workspace settings ==> enable "Data model settings"
![Desktop View](/assets/img/medallion/workspace.png)
...
![Desktop View](/assets/img/medallion/lakehouse.png)
...
![Desktop View](/assets/img/medallion/sqlendpoint.png)
![Desktop View](/assets/img/medallion/sqlquery.png)
...
![Desktop View](/assets/img/medallion/FactTable-Dims.png)
